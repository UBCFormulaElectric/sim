...
def create_vertical_section(data):
    ...
    lines = [
        ...
        f"Q_RE0                    = {loaded_radius.get('QRE0', 1.0):<17}$Ratio of free tire radius with nominal tire radius",
        f"Q_V1                     = {loaded_radius.get('QV1', 0):<17}$Tire radius increase with speed",
        f"Q_V2                     = {loaded_radius.get('QV2', 0):<17}$Vertical stiffness increase with speed",
